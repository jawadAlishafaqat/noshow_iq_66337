...
_FEATURE_ORDER = None  # set during train, used during predict
...
def predict(record: dict):
    """Single-record prediction. record is the cleaned, engineered feature dict."""
    import pandas as pd
    clf, features = load()
    ...
    rec = {
        ...
        'MEDIUM': 'Send SMS reminder 24h before.',
